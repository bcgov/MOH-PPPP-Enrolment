<template>
  <div>
    ...
    <InputComponent
      ...
      class="mt-3"
      :cypress-id="'msc-service-clarification-code-' + index"
    ...
    <TimeInput
      ...
      class-name="mt-3"
      :cypress-id="'msc-called-start-time-' + index"
    ...
    <TimeInput
      ...
      class-name="mt-3"
      :cypress-id="'msc-rendered-finish-time-' + index"
    ...
    <SelectComponent
      ...
      class="mt-3"
      :cypress-id="'msc-correspondence-attached-' + index"
