...
const SPA_ENV_SERVER_URL = '/pppp/api/env';
 ...
 */
const serverEnvs = {
  SPA_ENV_PPPP_MAINTENANCE_FLAG: '',
  SPA_ENV_PPPP_MAINTENANCE_START: '',
  SPA_ENV_PPPP_MAINTENANCE_END: '',
  SPA_ENV_PPPP_MAINTENANCE_MESSAGE: '',
  SPA_ENV_PPPP_IS_CSR_ENABLED: '',
};
