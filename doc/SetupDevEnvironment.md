...
3. apply the quickstart pppp web (for dev, make sure your default oc project is dev):
cd /openshift/templates
```console
oc process -f quickppppweb-toall.yaml NAMESPACE=0752cb-dev | oc apply -f -
```
...
4. allow the dev project to pull from tools:
   Go to the dev project (oc project 0752cb-dev).
```console
